...
//---Your code goes here
	...
	if(root->leftChild){
		...
		Node* placeholder = root->leftChild;
		//perform rotation
		root->leftChild = root->leftChild->rightChild;
		placeholder->rightChild = root;
		//recalculate height for each aspect
		root->height = calcHeight(root);
		placeholder->height = calcHeight(placeholder);
		return placeholder;
	}
	else{
		return root;
...
//---Your code goes here
	...
	//create placeholder node
	Node* placeholder = root->rightChild;
	if(root->rightChild){
		//perform rotation
		root->rightChild = root->rightChild->leftChild;
		placeholder->leftChild = root;
		//recalculate height for each aspect
		root->height = calcHeight(root);
		placeholder->height = calcHeight(placeholder);
		return placeholder;
